...
export default function Waitlist() {
    ...
    return (
        <div className={styles.page}>
            <TigerCanvas opacity={0.5} />

            <div className={styles.content}>
                <div className={styles.label}>Early Access</div>

                <h1 className={styles.headline}>
                    Programmable Credit<br />
                    <span className={styles.headlineAccent}>is Coming.</span>
                </h1>
                ...
                <div className={styles.socials}>
                    <a href="https://x.com/krexa_xyz" target="_blank" rel="noopener" aria-label="Twitter">
                    ...
                    <a href="https://t.me/krexa_xyz" target="_blank" rel="noopener" aria-label="Telegram">
