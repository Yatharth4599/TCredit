...
export default function Waitlist() {
    ...
    return (
        <div className={styles.page}>
            <TigerCanvas opacity={0.4} />
            <div className={styles.glowOrg} />
            ...
            <div className={styles.content}>
                ...
                <h1 className={styles.headline}>
                    <span className={`${styles.headlineLine} ${mounted ? styles.visible : ''}`}>
                        <DecryptedText
                            text="Programmable Credit"
                            parentClassName={styles.headlineWord}
                    ...
                    <span className={`${styles.headlineLine} ${styles.headlineLine2} ${mounted ? styles.visible : ''}`}>
                        <DecryptedText
                            text="is Coming."
                            parentClassName={styles.headlineGradient}
                            encryptedClassName={styles.encryptedChar}
                            animateOn="view"
                            speed={40}
                            maxIterations={40}
                ...
                {submitted ? (
                    <div className={`${styles.successBlock} ${mounted ? styles.visible : ''}`}>
                        <h3 className={styles.successTitle}>You're on the list.</h3>
                        <p className={styles.successSub}>We'll reach out before launch.</p>
                    </div>
                ) : (
                    <div className={`${styles.formWrap} ${mounted ? styles.visible : ''}`}>
                ...
                <div className={`${styles.socials} ${mounted ? styles.visible : ''}`}>
                ...
                <Link to="/" className={`${styles.backLink} ${mounted ? styles.visible : ''}`}>
