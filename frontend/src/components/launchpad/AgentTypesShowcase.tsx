...
const categories: AgentCategory[] = [
  {
    ...
    typeId: 0,
    templates: [
      { name: 'DEX Arbitrage', desc: 'Catch price gaps across Jupiter, Orca, Raydium.', revenue: '~30\u201380%', revenueLabel: 'APY', frameworks: [{ name: 'Krexa MCP (22 tools)', url: 'https://krexa.mintlify.app/docs/quickstart', isNew: true }, { name: '1inch MCP', url: 'https://blog.1inch.com/1inch-business-mcp/', isNew: true }, { name: 'OKX OnchainOS', url: 'https://www.okx.com/web3/build/docs/devportal/introduction-to-developer-portal-interface', isNew: true }, { name: 'Meteora DLMM', url: 'https://docs.meteora.ag/docs/dlmm/overview' }, 'Jupiter SDK', 'Olas', 'Python'] },
      { name: 'Yield Optimizer', desc: 'Move capital to highest yield pools on Kamino, MarginFi.', revenue: '~15\u201340%', revenueLabel: 'APY', frameworks: [{ name: 'Krexa MCP (22 tools)', url: 'https://krexa.mintlify.app/docs/quickstart', isNew: true }, { name: '1inch MCP', url: 'https://blog.1inch.com/1inch-business-mcp/', isNew: true }, { name: 'OKX OnchainOS', url: 'https://www.okx.com/web3/build/docs/devportal/introduction-to-developer-portal-interface', isNew: true }, { name: 'Meteora DLMM', url: 'https://docs.meteora.ag/docs/dlmm/overview' }, 'Kamino SDK', 'ElizaOS', 'TypeScript'] },
      { name: 'Market Making', desc: 'Provide liquidity and earn bid-ask spreads.', revenue: '~20\u201360%', revenueLabel: 'APY', frameworks: [{ name: 'Krexa MCP (22 tools)', url: 'https://krexa.mintlify.app/docs/quickstart', isNew: true }, { name: '1inch MCP', url: 'https://blog.1inch.com/1inch-business-mcp/', isNew: true }, { name: 'OKX OnchainOS', url: 'https://www.okx.com/web3/build/docs/devportal/introduction-to-developer-portal-interface', isNew: true }, { name: 'Meteora DLMM', url: 'https://docs.meteora.ag/docs/dlmm/overview' }, 'Orca SDK', 'Hummingbot', 'Python'] },
      { name: 'Meteora LP', desc: 'Provide concentrated liquidity on Meteora DLMM. Auto-manage bins. Earn swap fees + dynamic fee bonuses.', revenue: '~15\u201340%', revenueLabel: 'APY', frameworks: [{ name: 'Krexa MCP (22 tools)', url: 'https://krexa.mintlify.app/docs/quickstart', isNew: true }, { name: 'Meteora DLMM', url: 'https://docs.meteora.ag/docs/dlmm/overview' }, { name: '1inch MCP', url: 'https://blog.1inch.com/1inch-business-mcp/', isNew: true }, 'Claude Code', 'TypeScript'] },
    ],
  },
  {
    label: 'TYPE B',
