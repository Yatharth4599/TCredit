/**
 * init-devnet.ts — initializes all 5 Krexa programs on devnet.
...
`;
  ...
  log('\n════════════════════════════════════════');
  log('All 5 programs initialized on devnet ✓');
  log(`  Venue:    HyWQrHG14Sw6KpKYSMiBDmVj5u7PXfLWvim6FHbBLmua`);
