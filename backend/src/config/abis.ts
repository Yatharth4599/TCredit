...
// Run: cd base-contracts && python3 scripts/gen-abis.py
...
export const AgentRegistryABI = [
    ...
    "outputs": [
      {
        "name": "",
        "type": "tuple",
        "internalType": "struct IAgentRegistry.CreditProfile",
        "components": [
          {
            "name": "score",
            "type": "uint16",
          ...
          },
          {
            "name": "tier",
            "type": "uint8",
            "internalType": "enum IAgentRegistry.CreditTier"
          },
          {
            "name": "updatedAt",
            "type": "uint256",
  ...
  {
    "type": "function",
    "name": "incrementPaymentsReceived",
    "inputs": [
      {
        "name": "agent",
        "type": "address",
    ...
    "inputs": [
      {
        "name": "payment",
        "type": "tuple",
        "internalType": "struct IPaymentRouter.X402Payment",
        "components": [
          {
            "name": "from",
            "type": "address",
    ...
    "outputs": [
      {
        "name": "",
        "type": "tuple",
        "internalType": "struct IPaymentRouter.Settlement",
        "components": [
          {
            "name": "vault",
            "type": "address",
...
export const VaultFactoryABI = [
  ...
  {
    "type": "event",
    "name": "PlatformPausedEvent",
    "inputs": [],
    "anonymous": false
  },
  {
    "type": "event",
    "name": "PlatformUnpausedEvent",
    "inputs": [],
    "anonymous": false
  },
  {
  ...
  {
    "type": "error",
    "name": "CreditScoreExpired",
    "inputs": []
  },
  {
    "type": "error",
    "name": "CreditTierTooLow",
    "inputs": []
  },
  {
    "type": "error",
...
export const MerchantVaultABI = [
    ...
    "inputs": [
      {
        "name": "p",
        "type": "tuple",
        "internalType": "struct MerchantVault.VaultParams",
        "components": [
          {
            "name": "usdc",
            "type": "address",
  ...
  {
    "type": "function",
    "name": "completeFundraisingManual",
    "inputs": [],
    "outputs": [],
    "stateMutability": "nonpayable"
  },
  ...
  {
    "type": "function",
    "name": "expectedRepaymentPerPeriod",
    "inputs": [],
    "outputs": [
      {
        "name": "",
    ...
    "outputs": [
      {
        "name": "",
        "type": "uint8",
        "internalType": "enum IMerchantVault.VaultState"
      }
    ],
    "stateMutability": "view"
  },
  ...
  {
    "type": "function",
    "name": "milestoneRegistry",
    "inputs": [],
    "outputs": [
      {
        "name": "",
        "type": "address",
        "internalType": "contract IMilestoneRegistry"
      }
    ],
    "stateMutability": "view"
  },
  ...
  {
    "type": "function",
    "name": "setMilestoneRegistry",
    "inputs": [
      {
        "name": "_milestoneRegistry",
        "type": "address",
        "internalType": "address"
      }
    ],
  ...
  {
    "type": "error",
    "name": "FundraisingAboveThreshold",
    "inputs": []
  },
  {
    "type": "error",
    "name": "FundraisingNotExpired",
    "inputs": []
  },
  {
    "type": "error",
    "name": "FundraisingThresholdNotMet",
    "inputs": []
  },
  {
    "type": "error",
    ...
    "outputs": [
      {
        "name": "",
        "type": "tuple",
        "internalType": "struct ILiquidityPool.PoolAllocation",
        "components": [
          {
            "name": "amount",
            "type": "uint256",
...
export const MilestoneRegistryABI = [
    ...
    "outputs": [
      {
        "name": "",
        "type": "tuple",
        "internalType": "struct IMilestoneRegistry.Milestone",
        "components": [
          {
            "name": "vault",
            "type": "address",
          ...
          },
          {
            "name": "status",
            "type": "uint8",
            "internalType": "enum IMilestoneRegistry.MilestoneStatus"
          },
          {
            "name": "approvalCount",
            "type": "uint256",
  ...
  {
    "type": "error",
    "name": "MilestoneAlreadyFinalized",
    "inputs": []
  },
  {
    "type": "error",
    "name": "MilestoneAlreadyVoted",
    "inputs": []
  },
  {
    "type": "error",
